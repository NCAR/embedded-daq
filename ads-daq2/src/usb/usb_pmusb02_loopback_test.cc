...
int USB_2_BenchmarkTest(libusb_device_handle *handle_udev, int usbIndex)
{
	...
	// int	iTotalHistory = 0
        int MaxHistory = 0, MinHistory = 0, NumFrames = 0, History[64] = {0};
	int	iTotalHistoryMeasured = 0, iFirstFrameVal = 0, iLastFrameVal = 0;
	float	flAveHistoryMeasured = 0.0;
        // float flAveHistoryPossible = 0.0;
	float	MaxRate = 0.0, MinRate = 0.0, AverageRate =0.0;
	// float	OverallMaxRate =0.0;
        float TotalOfAverageRate = 0.0, OverallAverageRate =0.0, OverallMinRate = 99999.0;
	int	iLastFrameIndex = 0;
	bool	TestInvalid = false;
	int	iNumTestInvalid = 0;
	float	g_flMaxReadRate = 0, g_flMaxWriteRate = 0;
        // float g_flMaxRate = 0;
	...
	memset(outBuffer, 0, USB_2_BENCHMARKHSBUFFERSIZE);
	memset(inBuffer, 0, USB_2_BENCHMARKHSBUFFERSIZE);
